...
const PaperTrades = {
  ...
  _strategyHelp: {
    'mean_reversion': {
      ...
      example: 'If SPY drops from around $550 to $535 on light volume while the overall market is healthy, Mean Reversion buys expecting it to recover toward $550.',
    },
    'sector_rotation': {
    ...
    'value_investing': {
      ...
      example: 'A solid bank like TD trading at $80 when similar banks trade at $90 — you buy expecting the market to recognize its true value.',
    },
    'macro_hedge': {
      name: 'Macro Hedge',
      emoji: '🌍',
    ...
    'backtest-v23': {
      ...
      when: 'Active when VIX is in the moderate range (above 12) \u2014 the sweet spot for this strategy.',
